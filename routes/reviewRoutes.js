...
router.route('/').get(checkValidator,reviewController.getAllReviews).post(authController.restrictTo('user'),createReviewValidator,checkValidator,reviewController.setTourUserIds,reviewController.createReview);
